# COMP5111 (Spring 2022) Assignment 1
...
#### Libraries
- [Randoop 4.2.7](https://github.com/randoop/randoop/releases/download/v4.2.7/randoop-4.2.7.zip)
...
Randoop is a tool to generate JUnit test suites. A short tutorial about Randoop is avaiable [here](./tutorials/randoop.md), including how to use Randoop to generate unit tests, and execute them using Eclipse.
